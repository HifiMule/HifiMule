# Project Context: HifiMule

## Overview
**HifiMule** is a desktop application for synchronizing Jellyfin media libraries to legacy mass-storage MP3 players (DAPs, iPods with Rockbox, etc.).

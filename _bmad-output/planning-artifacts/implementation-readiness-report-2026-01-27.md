...
NFR5: The `.jellysync.json` manifest must be updated atomically to prevent corruption during unexpected power loss or disconnection.
...
| FR3 | The system can identify the presence of a `.jellysync.json` manifest on discovery. | Epic 2 - Manifest Presence Check | ✓ Covered |

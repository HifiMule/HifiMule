...
- 2026-04-06: Added macOS universal binary support — matrix restructured to `include` format, daemon cross-compiled for both `aarch64-apple-darwin` and `x86_64-apple-darwin`, `tauri-action` called with `--target universal-apple-darwin`.

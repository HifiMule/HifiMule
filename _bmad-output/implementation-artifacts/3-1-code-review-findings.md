...
**Location:** `hifimule-ui/src/library.ts` lines 91-94
...
**Location:** `hifimule-ui/src/library.ts` line 81 (`createMediaCard`)
...
**Location:** `hifimule-ui/src/library.ts` line 190 (`initLibraryView`)
...
**Location:** `hifimule-ui/src/library.ts` line 140
...
**Location:** `hifimule-daemon/src/rpc.rs` line 391
...
**Location:** `hifimule-ui/src/library.ts` line 3

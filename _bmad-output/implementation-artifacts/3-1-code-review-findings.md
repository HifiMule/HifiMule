...
**Location:** `jellyfinsync-ui/src/library.ts` lines 91-94
...
**Location:** `jellyfinsync-ui/src/library.ts` line 81 (`createMediaCard`)
...
**Location:** `jellyfinsync-ui/src/library.ts` line 190 (`initLibraryView`)
...
**Location:** `jellyfinsync-ui/src/library.ts` line 140
...
**Location:** `jellyfinsync-daemon/src/rpc.rs` line 391
...
**Location:** `jellyfinsync-ui/src/library.ts` line 3

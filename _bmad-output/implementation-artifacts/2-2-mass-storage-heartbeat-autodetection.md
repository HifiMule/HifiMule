...
2. **Manifest Probing:** Upon detection, the daemon MUST automatically check the root directory of the new mount for a `.jellysync.json` manifest. (AC: #2)
...
- [x] **T2: Implement Manifest Probing & Validation** (AC: #2)
  ...
  - [x] Parse `.jellysync.json` if it exists.
...
- **Source tree components to touch:**
  - `jellysync-daemon/src/main.rs`: Integrate the mount observer.
  - `jellysync-daemon/src/device/`: Create new module for device discovery.
...
- [main.rs](file:///C:/Workspaces/JellyfinSync/jellysync-daemon/src/main.rs)
- [device/mod.rs](file:///C:/Workspaces/JellyfinSync/jellysync-daemon/src/device/mod.rs)
- [device/tests.rs](file:///C:/Workspaces/JellyfinSync/jellysync-daemon/src/device/tests.rs)
- [Cargo.toml](file:///C:/Workspaces/JellyfinSync/Cargo.toml)
- [jellysync-daemon/Cargo.toml](file:///C:/Workspaces/JellyfinSync/jellysync-daemon/Cargo.toml)
